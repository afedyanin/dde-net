 ...
 */
#endregion
namespace DdeNet.Foundation.Advanced
{
    using System;
    ...
    internal sealed class DdemlTransaction
    {
        ...
        private int    _uFmt    = 0;
        private IntPtr _hConv   = IntPtr.Zero;
        private IntPtr _hsz1    = IntPtr.Zero;
        private IntPtr _hsz2    = IntPtr.Zero;
        private IntPtr _hData   = IntPtr.Zero;
        private IntPtr _dwData1 = IntPtr.Zero;
        private IntPtr _dwData2 = IntPtr.Zero;
        private IntPtr _dwRet   = IntPtr.Zero;

        public DdemlTransaction(int uType, int uFmt, IntPtr hConv, IntPtr hsz1, IntPtr hsz2, IntPtr hData, IntPtr dwData1, IntPtr dwData2)
        {
            _uType = uType;
            _uFmt = uFmt;
            _hConv = hConv;
