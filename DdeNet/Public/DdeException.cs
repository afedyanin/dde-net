...
namespace DdeNet
{
    ...
    public class DdeException : Exception
    {
        ...
        {
            _DdemlObject = (DdemlException)info.GetValue("DdeNet.DdeException.DdemlObject", typeof(DdemlException));
        }
        ...
        {
            info.AddValue("DdeNet.DdeException.DdemlObject", _DdemlObject);
